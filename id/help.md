...
- Tidak bergantung pada perusahaan atau layanan apa pun. _Anda_ memiliki data Anda.
- Data Anda tidak disimpan di server pusat kecuali jika semua pengguna menggunakan
  menggunakan server email yang sama
- Anda tidak mendistribusikan buku alamat Anda kepada siapa pun.
- _Cepat_ dengan menggunakan Push-IMAP.
- Basis pengguna terbesar - penerima yang tidak menggunakan Delta Chat juga dapat dihubungi.
- _No Spam_ - hanya pesan dari pengguna yang dikenal yang ditampilkan secara default.
- Enkripsi ujung-ke-ujung melalui Autocrypt.
- Perangkat lunak bebas berbasis _Copyleft_ dan _Standar_.
- Identitas yang fleksibel dengan dukungan bawaan untuk [beberapa akun](#multiple-accounts)
