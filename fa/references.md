...
> این فهرست به‌طور مکرر به‌روز نمی‌شود.
> منابع و صدای کاربران به‌روزتر را می‌توانید در [فدیورس](https://chaos.social/tags/deltachat) پیدا کنید.
...
این مقاله درباره Autocrypt است، مشخصاتی که دلتاچت برای راه‌اندازی سرتاسری استفاده می‌کند.
دلتاچت در حاشیه ذکر شده است.
...
همچنین [داستان‌ها و صدای کاربران](user-voices) را ببینید.
