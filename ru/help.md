...
- Из Delta Chat вы можете написать людям использующим Delta Chat или любой другой существующий клиент электронной почты. Это одно из самых больших отличий от других мессенджеров: у получателя нет необходимости устанавливать то же приложение, что и у вас.
