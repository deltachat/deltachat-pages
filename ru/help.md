...
Delta Chat напоминает Whatsapp или Telegram, но его можно использовать и приложение электронной почты. 
...
- Если сообщение приходит от неизвестного контакта, оно отображается как **запрос**. Чтобы
  ответить, вам необходимо сначала принять запрос.
- Вы также можете "удалить" его, если не хотите общаться с ним в данный момент. Это
  *не* удаляет сообщение с сервера, а только с вашего устройства. Таким образом,
  вы все еще можете обработать сообщение в другом почтовом клиенте.
