...
A beta-state Android version is available on F-Droid. After the [version 1.0 release](https://github.com/orgs/deltachat/projects/2?fullscreen=true) availability on Google Play will follow. 
