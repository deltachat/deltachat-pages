...
if messages with that contact will be guaranteed to be End-to-End encrypted.
...
of what is called "green-checkmarked" or "guaranteed end-to-end encrypted" chats.
