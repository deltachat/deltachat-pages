...
- writing all documentation, pull request and issue descriptions,
  comments, and commit messages by hand,
...
that are not aligned with our standards or current project plans.
...
Our Community Standards apply to project repositories, communication channels,
and gatherings, as well as to public spaces,
when an individual is representing the project or its community.
Examples of representing a project or community include
using an official project e-mail address,
posting via a social media account associated with the project,
