...
- **No cleartext Auto-Submitted or threading headers.**
  In addition to To, Subject, and group membership headers, we're now also protecting
...
- **Securejoin v3 hides cryptographic identities.**
  ...
  encrypts all of these initial messages, including the very first one.
...
Our new release brings [initial multi-path delivery](https://github.com/chatmail/core/issues/7357):
