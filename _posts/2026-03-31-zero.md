...
Our new release introduce [multi-path delivery](https://github.com/chatmail/core/issues/7357):
...
you can now avoid a single point of failure.
Currently, adding secondary relays is a manual step (Advanced Settings -> Relays)
but you **need to upgrade all your devices first to 2.48+ releases before trying it**.

<img src="../assets/blog/2026-03-30-relays.png" style="width:320px;" />

Once the dust settles and we conducted more research,
we'll tackle automating and randomizing the onboarding process:
...
We are doing what we can to provide an unstoppable planetary-scale instant messenging experience,
and if you want to help it, please consider [contributing work or money](https://delta.chat/en/contribute)
and/or maybe see if you can motivate and help friends and family to use it.
To that end, maybe take a look at the revamped [webxdc page featuring secure mini apps for increasingly many messengers](https://webxdc.org)?
