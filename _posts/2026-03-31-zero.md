...
While we continuously work to close the security and privacy gaps between Delta Chat and Signal, 
we'd like to remind everyone that Telegram has reached one billion users. 
Many people prioritize user experience and UI, 
...
Talk about masterclasses in effective propaganda.

Delta Chat has always been a pragmatic, down-to-earth, user-interface-oriented project.
...
Our ['find a messenger with more convinient onboarding UX' challenge](https://chaos.social/@delta/115479392746850836),
remains open for submissions :)

As we enter 2026, the rise of authoritarianism makes communication resilience critical 
for an increasing number of "at-risk" users.
...
Availability is the foundation of security in emergency situations.
...
Our new releases introduce [multi-path delivery](https://github.com/chatmail/core/issues/7357).
Each profile can now use multiple chatmail relays for sending and receiving.
If one relay is blocked, messages automatically flow through another.
...
Currently, adding secondary relays is a manual step in "Advanced Settings ->
Relays". Ensure all your devices are upgraded to version 2.48 or later before
enabling this feature. Once we have conducted more research, we plan to
automate this process so that profiles learn about new relays organically.

<img src="../assets/blog/2026-03-30-relays.png" style="width:320px;" />

We are aiming for an unstoppable, planetary-scale instant messaging experience.
If you would like to support us,
please consider [contributing or donating](https://delta.chat/en/contribute).

Oh, and if you are just left wondering how to possibly motivate your peers to use Delta Chat with you,
maybe explore our revamped [webxdc page](https://webxdc.org),
through which Delta Chat provides secure mini-apps for private coordination and gaming.
