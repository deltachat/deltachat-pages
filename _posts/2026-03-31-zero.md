...
but we decided to maintain end-to-end compatibility with other encrypting email apps,
...
We may land "Sealed Sender" support eventually,
but we are likely first aiming for [Autocrypt2 support](https://autocrypt2.org),
a new specification to provide Post-Quantum-Cryptography and Reliable Deletion ("Forward Secrecy").
...
<img src="../assets/blog/2026-03-30-android-calls.jpg" style="width:250px;" />
...
Luckily, there are some wealthy people supporting development of DeltaTouch in particular,
a pretty much feature-parity Delta Chat client available on many "Lomiri" platforms.

The DeltaTouch lead devs recently landed full audio/video calls,
compatible with Delta Chat and all other chatmail clients.
If you have C++ and QT knowledge and interest,
by all means feel free to engage with the [Codeberg DeltaTouch repository](https://codeberg.org/lk108/deltatouch),
...
<img src="../assets/blog/2026-03-31-deltatouch-4.png" style="width:185px;" />
...
<img src="../assets/blog/2026-03-30-group-descr-android.png" style="width:275px;" /> &nbsp;
<img src="../assets/blog/2026-03-30-group-descr-ios.png" style="width:250px;" />
...
## Download on demand revamped (what an effort!)

We fundamentally re-implemented the years-old "download on demand" feature.
...
For over a decade, security-oriented messengers have been urged and cheered on
...
But we'd like to kindly remind everyone that Telegram has reached one billion users.
...
remains btw open for submissions. No strong competitors emerged so far :)
...
its security features provide zero practical benefit.
...
Better, even more resilience and availability is coming ...
...
<img src="../assets/blog/2026-03-31-relay-network-drawing.jpg" alt="Hand-drawn relay network redundancy diagram by anonymous author" title="Diagram showing Alice and Bob connected through six relay servers (@1 to @6), illustrating how communication continues even if some servers fail." style="width:450px;" />
