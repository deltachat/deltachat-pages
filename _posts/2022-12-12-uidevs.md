---
title: Want to get money to help improving Delta Chat UI/UX?
author: olgax
...
- **adaptable**: [Indigenous](https://rhizomatica.org) communities
  use solar powered routers deep in the rainforest,
...
![Desktop background image screenshot](../assets/blog/2020-03-26-bots-2.jpg")

Our [Desktop client](https://github.com/deltachat/deltachat-desktop) uses Web technology (React, TypeScript), currently via
...
Several of us avoid flying and some are involved in Friday-lor-Futures or adjacent activities.
