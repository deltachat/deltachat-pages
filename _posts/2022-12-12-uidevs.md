---
title: Delta Chat backgrounds; want a UI/UX dev job by chance?
author: olgax
...
<img src="../assets/blog/2020-06-faster.jpg" width="270" style="float:left; margin-right:1em;" />
...
<video autoplay="" muted="" loop="" playsinline="" style="float: right ; width:270px; margin-right: 1em; max-width: 100%;"><source src="https://webxdc.org/assets/deltagif.mp4" type="video/mp4"><img aria-hidden="true" src="https://webxdc.org/assets/screenshots/tower-builder.png"></video>
<img src="../assets/blog/2022-12-webxdc-poll.jpg" width="270" style="float:left; margin-left:1em;" />
...
makes more sense if you consider the chat web app is distributed in an anonymizing mailing list ;)
...
UX and privacy researchers, programmers from diverse projects such as Cryptpad, DAT, IPFS,
libreoffice and also many folks from the fediverse agree:
...
In 2023, we want to perform systematic user and field-testing around security topics,
...
Many users do not have a good e-mail address and can't easily get one.
We are experimenting with a single-click or QR-code based sign-up that
quickly bootstraps a working account configured with Delta Chat.
...
and interesting conversations are now evolving.
...
<img src="../assets/blog/2020-03-26-bots-2.jpg" width="270" style="float:left; margin-right:1em;" />
