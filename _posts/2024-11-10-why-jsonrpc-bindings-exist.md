...
For this purpose the cffi api actually contains the jsonrpc api and provides both syncronous and asynchronous access to it[^jsonrpc_in_cffi]. (These apis were also used in desktop before we switched to the stdio-rpc-server binary)
