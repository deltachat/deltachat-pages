...
**Import Notes about this release**:

- **Don't forget to Synchronize Android/iOS to Desktop:** if you install Delta Chat desktop next
  to an an already existing mobile version you need to synchronize your setups. 
...
- **Delta Chat Desktop is well usable but does not have all UX features
  ...
  process could be nicer for existing Android/iOS Delta Chat users could be nicer ;) 
