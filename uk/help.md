...
- Якщо у вас виникнуть питання, ви можете звернутися до досвідчених користувачів на [форумі Delta Chat](https://підтримка.delta.chat/c/webxdc/20).
...
Зверніть увагу, що Delta Chat має [невелику систему push-сповіщень, яка зберігає конфіденційність](#конфіденційність-notifications), яка забезпечує «миттєву доставку» повідомлень для всіх серверів chatmail, включно з тим, який [ви можете налаштувати самостійно без нашого дозволу](https://delta.chat/chatmail#selfhosted). Ласкаво просимо до потужної мережі взаємосумісних ретрансляторів чат-пошти :)
...
Щоб дізнатися більше про ретранслятори та їхні майбутні можливості, ви можете стежити за обговореннями на [форумі](https://підтримка.delta.chat).
