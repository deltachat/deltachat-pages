...
> **Përditësim:** Ky është i vjetruar - tanimë rekomandojmë
> [Chatmail Relays](2023-12-13-chatmail), në vend se shërbyes mailcow, për Delta Chat-in,
> për dërgim më të shpejtë, njoftime push të qëndrueshme dhe fshehtëzim të zbatuar mesazhesh.
> Lexoni më tepër [në GitHub](https://github.com/chatmail/relay) rreth se si ta ujdisni!
> mailcow e shumta është një mundëso
> nëse doni të komunikoni me përdorues email- klasik që s’përdorin dot fshehtëzim.
