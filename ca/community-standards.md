---
title: Estàndards de la Comunitat
lang: ca
---
...
* Respectar punts de vista i experiències diferents
* Acceptar de manera correcta les crítiques constructives
* Mostrar empatia envers els membres de la comunitat i els nous participants
* Ajudar i mediar en casos de conflictes o malentesos

Exemples de comportaments que demanem a tothom que eviti inclouen:

* L’ús de llenguatge o imatges sexualitzades i l’atenció o propostes sexuals no desitjades
* Provocar, fer comentaris insultants/denigrants i atacs personals o polítics
...
Si experimentes o presencies un comportament abusiu, assetjador o d’una altra manera inacceptable, 
pots parlar amb alguns dels responsables del projecte, actualment [Nami](mailto:missytake@systemli.org) i [Xenia](mailto:ksenia@transcyberian.org).
Ells revisaran els informes i involucraran altres responsables segons sigui necessari, i respondran d’una manera que es consideri necessària i adequada a les circumstàncies, però sense actuar en contra de la teva voluntat.

Els responsables tenen l’obligació de mantenir la confidencialitat respecte a la persona que informa d’un incident.
Els responsables no estan exempts de poder ser reportats i poden enfrontar repercussions temporals o permanents segons el criteri dels altres responsables.
